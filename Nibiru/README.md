...
```
wget -O nibiru.sh https://raw.githubusercontent.com/mggnet/testnet/main/Nibiru/nibiru.sh && chmod +x nibiru.sh && ./nibiru.sh
```
...
To top up your wallet join [nibiru discord server](https://discord.gg/nibiru) and navigate to:
